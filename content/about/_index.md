...
LibreSCRS started as a reverse-engineering effort to liberate Serbian government smart cards from Windows-only proprietary software. Through protocol analysis and AI-assisted development, we built open-source tools that read card data (Serbian eID, health, EU vehicle registration, eMRTD passports) and provide full PKI through OpenSC.
...
5. **2026** — eMRTD and PKCS#15 support: e-passports plus PKCS#15-based PKI cards. PKCS#11 module generalized across card families.
