...
| `cardedge` | Gemalto CardEdge аплет — PIN операције, потписивање, откривање сертификата (PKI за српске еИД) |
