...
Десктоп апликација за читање српских смарт картица.
...
Учитајте овај модул у ваш прегледач, клијент електронске поште или SSH за коришћење смарт картице за аутентификацију и дигиталне потписе.
...
OpenSC екстерни драјвер за картице. Потребан само ако желите да OpenSC алати (`pkcs15-tool`, `pkcs11-tool`) раде са српским личним картицама и ПКС картицама.
