...
Gemalto 2014+, IF2020 Foreigner. Лични подаци, адреса, информације о документу, фотографија. Сертификати дигиталног потписа и управљање PIN-ом преко OpenSC srbeid (Gemalto 2014+) и PKCS#15 (Apollo 2008, IF2020 Foreigner).
...
Генерички PKI стандард за откривање сертификата, управљање PIN-ом и дигитално потписивање. Покрива Gemalto, AET SafeSign QSCD (Infineon) и друге компатибилне картице — укључујући PKI на националним картицама са eMRTD подршком.
...
- **PKCS#11 модул** — универзални криптографски интерфејс који подржава PKI картице кроз OpenSC (српска лична карта/ПКС, PIV, генерички PKCS#15). Коришћење у Firefox-у, Chrome-у, SSH-у и потписивању е-поште.
