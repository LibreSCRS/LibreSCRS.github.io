...
**Подржане картице** (CardEdge аплет):
- Лична карта Gemalto (2014+) и IF2020 за странце
- ПКС картица Привредне коморе

Генеричке PKCS#15 картице нису подржане од стране PKCS#11 модула.
