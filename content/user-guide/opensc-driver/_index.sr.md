...
> **Привремено — овај драјвер ће бити застарео.** Уграђени драјвер за српске картице је [предложен за OpenSC](https://github.com/OpenSC/OpenSC/pull/3595) и одобрен за укључивање од стране OpenSC одржавалаца. Када следеће издање OpenSC-а буде објављено, овај екстерни драјвер више неће бити потребан — само инсталирајте OpenSC. До тада, овај драјвер остаје потпуно функционалан.
