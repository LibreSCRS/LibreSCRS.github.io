...
> по апликацији) стигло је у LibreMiddleware 4.1.0 и укључено је у 4.2.0.
> Ручни кораци по апликацији испод потребни су само на старијем издању
> 4.0.0, или за апликације које не користе p11-kit регистар модула.
