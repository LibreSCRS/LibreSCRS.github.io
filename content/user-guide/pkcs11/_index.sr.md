...
> по апликацији) стигло је у LibreMiddleware 4.1.0-dev (за сада изградите
> 4.1 грану из изворног кода; биће укључено у следеће стабилно издање).
> У 4.0.0 и даље је потребно ручно усмерити сваку апликацију на
