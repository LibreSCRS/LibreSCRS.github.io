...
**Подржане картице:**
- Лична карта Gemalto (2014+) и IF2020 за странце (CardEdge)
- ПКС картица Привредне коморе (CardEdge)
- Било која PKCS#15-компатибилна смарт картица
- PIV картице (NIST SP 800-73)
